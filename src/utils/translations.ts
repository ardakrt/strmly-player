  ...
  tr: {
    ...
    settings: {
      ...
      playlists: {
        ...
        playlistNamePlaceholder: "Örn. Premium IPTV, Ücretsiz Liste...",
      ...
      about: {
        title: "Hakkında",
        desc: "Strmly IPTV Player sürüm bilgileri ve güncellemeler.",
  ...
  en: {
    ...
    settings: {
      ...
      playlists: {
        ...
        playlistNamePlaceholder: "e.g., Premium IPTV, Free List...",
      ...
      about: {
        title: "About",
        desc: "Strmly IPTV Player version information and updates.",
